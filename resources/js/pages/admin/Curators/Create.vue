...
<template>
    <AppLayout
        :breadcrumbs="[
            ...
            { title: 'Создать', href: '/admin/curators/create' },
        ]"
    >
        <div class="mx-auto max-w-2xl space-y-6">
            <div>
                <h1 class="text-3xl font-bold">Создать куратора</h1>
                <p class="text-muted-foreground mt-2">
                    Добавьте нового куратора в систему
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Заполните основные данные куратора
                    </CardDescription>
                </CardHeader>
                <CardContent>
