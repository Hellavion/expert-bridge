...
const form = useForm({
    ...
    expert_id: props.product.expert_id,
...
<template>
    ...
    >
        <div class="mx-auto max-w-2xl space-y-6">
            <div>
                <h1 class="text-3xl font-bold">Редактировать продукт</h1>
                <p class="text-muted-foreground mt-2">
                    Обновите данные продукта {{ product.name }}
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Измените данные продукта и сохраните изменения
                    </CardDescription>
                </CardHeader>
                <CardContent>
