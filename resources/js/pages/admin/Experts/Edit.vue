...
const form = useForm({
    ...
    telegram_login: props.expert.telegram_login || '',
    comment: props.expert.comment || '',
    commission_percent: props.expert.commission_percent,
    expert_bonus: props.expert.expert_bonus || '',
    is_active: props.expert.is_active,
});

const submit = () => {
    form.put(`/admin/experts/${props.expert.id}`);
};
</script>
...
<template>
    ...
    >
        <div class="mx-auto max-w-2xl space-y-6">
            <div>
                <h1 class="text-3xl font-bold">Редактировать эксперта</h1>
                <p class="text-muted-foreground mt-2">
                    Обновите данные эксперта {{ expert.name }}
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Измените данные эксперта и сохраните изменения
                    </CardDescription>
                </CardHeader>
                <CardContent>
